...
st.write("""
This page displays the processed output video and summary metrics generated by the bag detection pipeline.
Your backend should write final outputs into the `outputs/` folder so the UI can load them here.
""")